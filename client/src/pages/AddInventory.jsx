  ...
  return (
    <section className='add-inventory p-3'>
      ...
      <div className="row mt-5">
        ...
        <div className="col-lg-6 mb-3">
          <label for="gauge" className="form-label fs-5 fw-semibold">Gauge</label>
          <input type="text" className="form-control form-control-lg fs-6 fw-normal" id="gauge" />
        </div>
        <div className="col-lg-6 mb-3">
        ...
        <div className="col-lg-6 mb-3">
          <label for="price" className="form-label fs-5 fw-semibold">Price per units</label>
